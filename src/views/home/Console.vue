<template>
  <main>
    <div class="left">
      <div class="top">
        <a href="/" class="logo"></a>
        <router-link to="/console" class="item">仪表盘</router-link>
        ...
        <router-link to="annex" class="item">
          <div style="display: flex; align-items: center">
            <svg viewBox="0 0 24 24" width="20px" height="20px">
              <path fill="currentColor"
                d="M3 3h18a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zm1 2v14h16V5H4zm8 10h6v2h-6v-2zm-3.333-3L5.838 9.172l1.415-1.415L11.495 12l-4.242 4.243l-1.415-1.415L8.667 12z">
              </path>
            </svg>
        ...
        <router-link to="annex" class="item">
          <div style="display: flex; align-items: center">
            ...
            <span style="margin-left: 5px">备份</span>
          </div>
        </router-link>
      </div>
      <div class="about">
        ...
        <div class="about-item">
          <span title="个人中心">
            <svg viewBox="0 0 24 24" width="1.5em" height="1.5em" class="h-5 w-5 text-gray-600 group-hover:text-gray-900">
              <path fill="currentColor"
          ...
          <span title="退出登录">
            <svg viewBox="0 0 24 24" width="1.5em" height="1.5em" offset="100"
